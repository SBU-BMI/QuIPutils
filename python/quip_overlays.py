...
parser.add_argument("--subfolders", required=True, type=int, metavar="value",
                    help="Should be 1, if the results folder has multiple result sets in subfolders.")
args = {}
...
if __name__ == "__main__":
    ...
    for mfolder in analysis_folders:
        ...
        if qres is None:
            ...
            db.metadata.update_one({'_id': qres['_id']}, {'$set': {'tile-location': provdoc["tile-location"]}},
                                   upsert=False)
